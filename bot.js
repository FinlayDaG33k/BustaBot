...
function calculateBasebet(balance) {
  var calcbaseBet = Math.floor(balance / minBalance);
  if (calcbaseBet > 2500) {
    calcbaseBet = 2500;
  }
...
if (typeof jQuery === 'undefined') {
  ...
  // now append the script into HEAD, it will fetch and be executed
  document.documentElement.firstChild.appendChild(script);
}

// now create an iFrames to support the development of this bot
// (please disable adblockers if you want to support me!)
